...
const Login = () => {
  return (
    <div id='login' className='bg-white py-8 px-4 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8'>
      <Link 
        to="/user-login" 
        className='w-full md:w-[30%] h-[5rem] bg-[#a4d0de] flex items-center justify-between px-4 md:px-8 font-bold rounded-md hover:h-[5.2rem] hover:w-full md:hover:w-[31%] hover:text-md transition-all'
      >
